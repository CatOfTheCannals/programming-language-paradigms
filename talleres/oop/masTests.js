...
function testEjercicio5(res) {
  ...
  let K_conoce_idK = "idK" in agenteK;
  let K_conoce_nK = "nK" in agenteK;
  res.write("El espÃ­a de Control" + si_o_no(C_conoce_idC) + "sabe responder idC", C_conoce_idC);
  res.write("El espÃ­a de Control" + si_o_no(C_conoce_nC) + "sabe responder nC", !C_conoce_nC);
  res.write("El espÃ­a de Control" + si_o_no(C_conoce_idK) + "sabe responder idK", !C_conoce_idK);
  res.write("El espÃ­a de Control" + si_o_no(C_conoce_nK) + "sabe responder nK", C_conoce_nK);
  res.write("El espÃ­a de Kaos" + si_o_no(K_conoce_idC) + "sabe responder idC", !K_conoce_idC);
  res.write("El espÃ­a de Kaos" + si_o_no(K_conoce_nC) + "sabe responder nC", K_conoce_nC);
  res.write("El espÃ­a de Kaos" + si_o_no(K_conoce_idK) + "sabe responder idK", K_conoce_idK);
  res.write("El espÃ­a de Kaos" + si_o_no(K_conoce_nK) + "sabe responder nK", !K_conoce_nK);
  let K_conoce_z = agenteK.z === 1;
  res.write("El espÃ­a de Kaos" + si_o_no(K_conoce_z) + "pasÃ³ por el programa de entrenamiento de Control", K_conoce_z);
  // Completar
  ...
  res.write("El doble espÃ­a de Control" + si_o_no(C_conoce_idC) + "sabe responder idC", C_conoce_idC);
  res.write("El doble espÃ­a de Control" + si_o_no(C_conoce_nC) + "sabe responder nC", C_conoce_nC);
  res.write("El doble espÃ­a de Control" + si_o_no(C_conoce_idK) + "sabe responder idK", !C_conoce_idK);
  res.write("El doble espÃ­a de Control" + si_o_no(C_conoce_nK) + "sabe responder nK", !C_conoce_nK);
  res.write("El ex-espÃ­a de Kaos" + si_o_no(K_conoce_idC) + "sabe responder idC", !K_conoce_idC);
  res.write("El ex-espÃ­a de Kaos" + si_o_no(K_conoce_nC) + "sabe responder nC", !K_conoce_nC);
  res.write("El ex-espÃ­a de Kaos" + si_o_no(K_conoce_idK) + "sabe responder idK", K_conoce_idK);
  res.write("El ex-espÃ­a de Kaos" + si_o_no(K_conoce_nK) + "sabe responder nK", K_conoce_nK);
  ...
  C_conoce_idK = "idK" in agenteC;
  C_conoce_nK = "nK" in agenteC;
  res.write("El ex-doble espÃ­a de Control" + si_o_no(C_conoce_idC) + "sabe responder idC", C_conoce_idC);
  res.write("El ex-doble espÃ­a de Control" + si_o_no(C_conoce_nC) + "sabe responder nC", C_conoce_nC);
  res.write("El ex-doble espÃ­a de Control" + si_o_no(C_conoce_idK) + "sabe responder idK", !C_conoce_idK);
  res.write("El ex-doble espÃ­a de Control" + si_o_no(C_conoce_nK) + "sabe responder nK", !C_conoce_nK);
  C_conoce_idC = agenteC.idC === 1;
  res.write("El ex-doble espÃ­a de Control" + si_o_no(C_conoce_idC) + "responde idC correctamente", C_conoce_idC);
